...
class OutstandingStatement(models.AbstractModel):
    ...
    _name = "report.bi_partner_outstanding_statement.outstanding_statement"
    ...
    def _get_report_values(self, docids, data=None):
        ...
        if "company_id" not in data:
            wiz = self.env["outstanding.statement.report.wiz"].with_context(active_ids=docids, model="res.partner")
