...
class ReplenishmentReportXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        domain = []
        domain.append(("product_tmpl_id.is_exclude_from_replenishment", "=", False))
        if flower_type_id:
            domain.append(("product_tmpl_id.flower_type_id", "=", flower_type_id))
        if sex_id:
            domain.append(("product_tmpl_id.product_sex_id", "=", sex_id))
        if size_id:
            domain.append(("product_tmpl_id.product_size_id", "=", size_id))
        if brand_breeder_id:
            domain.append(("product_tmpl_id.product_breeder_id", "=", brand_breeder_id))
        ...
        for product in product_ids:
            ...
            purchase_reserved_qty = sum(
                ...
                .filtered(lambda line: line.product_id == product)
                .mapped("product_qty")
            )
            ...
            if product.is_out_of_stock:
                ...
                worksheet.write("{}{}".format(letters[next_col + 5], row), avail_qty if avail_qty else "0", format5)
                worksheet.write("{}{}".format(letters[next_col + 6], row), order_qty, format5)
                ...
                worksheet.write(
                    "{}{}".format(letters[next_col + 10], row),
                ...
                worksheet.write(
                    ...
                    product.product_tmpl_id.product_breeder_id.breeder_name
                    if product.product_tmpl_id.product_breeder_id
                    else "",
                    format5_l,
                )
                worksheet.write(
                ...
                worksheet.write("{}{}".format(letters[next_col + 1], row), qty_onhand if qty_onhand else "0", format7)
                worksheet.write(
                    "{}{}".format(letters[next_col + 2], row), sale_reserved_qty if sale_reserved_qty else "0", format7
                )
                worksheet.write(
                    "{}{}".format(letters[next_col + 3], row),
                    purchase_reserved_qty if purchase_reserved_qty else "0",
                ...
                worksheet.write("{}{}".format(letters[next_col + 5], row), avail_qty if avail_qty else "0", format7)
                worksheet.write("{}{}".format(letters[next_col + 6], row), order_qty, format7)
                worksheet.write("{}{}".format(letters[next_col + 7], row), product.name, format7_l)
                worksheet.write("{}{}".format(letters[next_col + 8], row), product_tax_categories, format7_l)
                worksheet.write(
                    "{}{}".format(letters[next_col + 9], row), warehouse_id.name if warehouse_id else "", format7_l
                )
                worksheet.write(
                    "{}{}".format(letters[next_col + 10], row),
                    product.default_code if product.default_code else "",
                ...
                worksheet.write("{}{}".format(letters[next_col + 11], row), supplier, format7_l)
                worksheet.write(
                    "{}{}".format(letters[next_col + 12], row),
                    product.supplier_sku_no if product.supplier_sku_no else "",
                    format7,
                ...
                worksheet.write(
                    "{}{}".format(letters[next_col + 19], row), product.last_cost if product.last_cost else "0", format7
                )
                row += 1
            else:
                worksheet.write(
                ...
                worksheet.write("{}{}".format(letters[next_col + 5], row), avail_qty if avail_qty else "0", format6)
                worksheet.write("{}{}".format(letters[next_col + 6], row), order_qty, format6)
