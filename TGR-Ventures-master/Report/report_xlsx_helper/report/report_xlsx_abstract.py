...
class ReportXlsxAbstract(models.AbstractModel):
    ...
    def _define_xls_headers(self, workbook):
        ...
        report_date = fields.Datetime.context_timestamp(self.env.user, datetime.now()).strftime("%Y-%m-%d %H:%M")
        XLS_HEADERS["xls_footers"] = {
            "standard": ("&L&%(font_size)s&%(font_style)s" + report_date + "&R&%(font_size)s&%(font_style)s&P / &N")
            % hf_params
        }
    ...
    def _define_formats(self, workbook):
        ...
        FORMATS["format_ws_title"] = workbook.add_format({"bold": True, "font_size": 14})
        ...
        FORMATS["format_amount_left"] = workbook.add_format({"align": "left", "num_format": num_format})
        FORMATS["format_amount_center"] = workbook.add_format({"align": "center", "num_format": num_format})
        FORMATS["format_amount_right"] = workbook.add_format({"align": "right", "num_format": num_format})
        ...
        FORMATS["format_integer_left"] = workbook.add_format({"align": "left", "num_format": int_format})
        FORMATS["format_integer_center"] = workbook.add_format({"align": "center", "num_format": int_format})
        FORMATS["format_integer_right"] = workbook.add_format({"align": "right", "num_format": int_format})
        ...
        FORMATS["format_date_left"] = workbook.add_format({"align": "left", "num_format": date_format})
        FORMATS["format_date_center"] = workbook.add_format({"align": "center", "num_format": date_format})
        FORMATS["format_date_right"] = workbook.add_format({"align": "right", "num_format": date_format})

        FORMATS["format_left_bold"] = workbook.add_format({"align": "left", "bold": True})
        FORMATS["format_center_bold"] = workbook.add_format({"align": "center", "bold": True})
        FORMATS["format_right_bold"] = workbook.add_format({"align": "right", "bold": True})
        ...
        FORMATS["format_theader_grey_center"] = workbook.add_format(dict(theader_grey, align="center"))
        FORMATS["format_theader_grey_right"] = workbook.add_format(dict(theader_grey, align="right"))
        ...
        FORMATS["format_theader_yellow_center"] = workbook.add_format(dict(theader_yellow, align="center"))
        FORMATS["format_theader_yellow_right"] = workbook.add_format(dict(theader_yellow, align="right"))
        ...
        FORMATS["format_theader_yellow_amount_conditional_center"] = workbook.add_format(
        ...
        FORMATS["format_theader_yellow_percent_conditional_center"] = workbook.add_format(
            dict(theader_yellow, num_format=pct_format_conditional, align="center")
        )
        FORMATS["format_theader_yellow_percent_conditional_right"] = workbook.add_format(
        ...
        FORMATS["format_theader_yellow_integer_conditional_center"] = workbook.add_format(
            dict(theader_yellow, num_format=int_format_conditional, align="center")
        )
        FORMATS["format_theader_yellow_integer_conditional_right"] = workbook.add_format(
        ...
        FORMATS["format_theader_blue_center"] = workbook.add_format(dict(theader_blue, align="center"))
        FORMATS["format_theader_blue_right"] = workbook.add_format(dict(theader_blue, align="right"))
        ...
        FORMATS["format_tcell_center"] = workbook.add_format(dict(border, align="center"))
        FORMATS["format_tcell_right"] = workbook.add_format(dict(border, align="right"))
        FORMATS["format_tcell_amount_left"] = workbook.add_format(dict(border, num_format=num_format, align="left"))
        FORMATS["format_tcell_amount_center"] = workbook.add_format(dict(border, num_format=num_format, align="center"))
        FORMATS["format_tcell_amount_right"] = workbook.add_format(dict(border, num_format=num_format, align="right"))
        ...
        FORMATS["format_tcell_percent_left"] = workbook.add_format(dict(border, num_format=pct_format, align="left"))
        FORMATS["format_tcell_percent_center"] = workbook.add_format(
            dict(border, num_format=pct_format, align="center")
        )
        FORMATS["format_tcell_percent_right"] = workbook.add_format(dict(border, num_format=pct_format, align="right"))
        ...
        FORMATS["format_tcell_integer_left"] = workbook.add_format(dict(border, num_format=int_format, align="left"))
        FORMATS["format_tcell_integer_center"] = workbook.add_format(
            dict(border, num_format=int_format, align="center")
        )
        FORMATS["format_tcell_integer_right"] = workbook.add_format(dict(border, num_format=int_format, align="right"))
        ...
        FORMATS["format_tcell_date_left"] = workbook.add_format(dict(border, num_format=date_format, align="left"))
        FORMATS["format_tcell_date_center"] = workbook.add_format(dict(border, num_format=date_format, align="center"))
        FORMATS["format_tcell_date_right"] = workbook.add_format(dict(border, num_format=date_format, align="right"))

        FORMATS["format_tcell_left_bold"] = workbook.add_format(dict(border, align="left", bold=True))
        FORMATS["format_tcell_center_bold"] = workbook.add_format(dict(border, align="center", bold=True))
        FORMATS["format_tcell_right_bold"] = workbook.add_format(dict(border, align="right", bold=True))
    ...
    def _write_ws_title(self, ws, row_pos, ws_params, merge_range=False):
        ...
        if merge_range:
            ...
            if wl and len(wl) > 1:
                ws.merge_range(row_pos, 0, row_pos, len(wl) - 1, title, FORMATS["format_ws_title"])
        else:
