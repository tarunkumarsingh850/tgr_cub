...
class OutstandingStatementXslx(models.AbstractModel):
    ...
    def _write_currency_lines(self, row_pos, sheet, partner, currency, data):
        ...
        sheet.write(row_pos, 3, _("Description"), FORMATS["format_theader_yellow_center"])
        ...
        for line in currency_data.get("lines"):
            ...
            if line.get("name", "") != "/":
                if not line.get("ref", ""):
                    ...
                    if (line.get("ref", "") in line.get("name", "")) or (line.get("name", "") == line.get("ref", "")):
                        name_to_show = line.get("name", "")
                    else:
            ...
            sheet.write(row_pos, 4, line.get("amount", ""), FORMATS["current_money_format"])
            sheet.write(row_pos, 5, line.get("open_amount", ""), FORMATS["current_money_format"])
