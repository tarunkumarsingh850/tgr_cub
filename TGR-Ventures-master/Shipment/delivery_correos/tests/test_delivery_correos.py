...
class TestDeliveryCorreos(common.TransactionCase):
    ...
    def check_credentials(self):
        if not self.carrier.correos_username_test or (not self.carrier.correos_password_test):
    ...
    def test_correos_update_shipment_check_last_response_request_02(self):
        ...
        self.assertEqual(
            ...
            % (self.json_response[0]["error"]["codError"], self.json_response[0]["error"]["desError"]),
        )
