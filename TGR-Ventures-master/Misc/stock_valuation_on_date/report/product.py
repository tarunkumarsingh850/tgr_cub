...
class ProductProduct(models.Model):
    ...
    stock_fifo_real_time_aml_ids = fields.Many2many("account.move.line", compute="_compute_stock_value")
    stock_fifo_manual_move_ids = fields.Many2many("stock.move", compute="_compute_stock_value")
    ...
    def _compute_stock_value(self):
        ...
        """.format(
            value_field_name, from_clause, where_clause
        )
