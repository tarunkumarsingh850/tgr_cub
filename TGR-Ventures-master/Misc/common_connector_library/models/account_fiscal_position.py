...
class AccountFiscalPosition(models.Model):
    ...
    def _get_fpos_by_region(self, country_id=False, state_id=False, zipcode=False, vat_required=False):
        ...
        return self.search_fiscal_position_based_on_origin_country(
            origin_country_id, country_id, state_id, zipcode, vat_required
        )

    @api.model
    def search_fiscal_position_based_on_origin_country(
        self, origin_country_id, country_id, state_id, zipcode, vat_required
    ):
        """
