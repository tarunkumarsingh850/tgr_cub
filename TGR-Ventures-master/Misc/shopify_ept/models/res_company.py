...
class ResCompany(models.Model):
    ...
    shopify_onboarding_state = fields.Selection(
        selection=SHOPIFY_ONBOARDING_STATES, string="State of the shopify onboarding panel", default="not_done"
    )
    shopify_instance_onboarding_state = fields.Selection(
        selection=SHOPIFY_ONBOARDING_STATES, string="State of the shopify instance onboarding panel", default="not_done"
    )
    shopify_basic_configuration_onboarding_state = fields.Selection(
        SHOPIFY_ONBOARDING_STATES,
        default="not_done",
        string="State of the shopify basic configuration " "onboarding step",
    )
    shopify_financial_status_onboarding_state = fields.Selection(
        SHOPIFY_ONBOARDING_STATES, default="not_done", string="State of the onboarding shopify financial " "status step"
    )
    shopify_cron_configuration_onboarding_state = fields.Selection(
        SHOPIFY_ONBOARDING_STATES,
        default="not_done",
        string="State of the onboarding shopify cron " "configurations step",
    )
    is_create_shopify_more_instance = fields.Boolean(string="Is create shopify more instance?", default=False)
    shopify_onboarding_toggle_state = fields.Selection(
