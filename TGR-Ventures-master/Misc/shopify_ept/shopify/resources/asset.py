...
class Asset(ShopifyResource):
    ...
    def _prefix(cls, options={}):
        ...
        if theme_id:
            return "{}/themes/{}".format(cls.site, theme_id)
        else:
            return cls.site
    ...
    def find(cls, key=None, **kwargs):
        ...
        path_prefix = "{}/themes/{}".format(cls.site, theme_id) if theme_id else cls.site

        resource = cls.find_one("{}/assets.{}".format(path_prefix, cls.format.extension), **params)
