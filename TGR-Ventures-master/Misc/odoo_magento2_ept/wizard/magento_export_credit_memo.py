...
class MagentoExportCreditMemo(models.TransientModel):
    ...
    refund_type = fields.Selection(
        ...
        help="If checked then refunded online," "Other wise refunded offline",
    )
    is_return_stock = fields.Boolean(
        string="Return items to Stock?", help="If true, System will return the refunded items to " "stock."
    )
