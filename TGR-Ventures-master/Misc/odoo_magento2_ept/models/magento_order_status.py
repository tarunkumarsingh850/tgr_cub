...
class MagentoOrderStatusEpt(models.Model):
    ...
    m_order_status = fields.Char(string="Magento Orders", required=True, readonly=True, help="Magento Orders Status")
    ...
    _sql_constraints = [
        (
            "_magento_order_statue_map_unique_constraint",
