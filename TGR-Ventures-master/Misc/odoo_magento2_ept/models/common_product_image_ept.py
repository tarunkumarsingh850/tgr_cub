...
class CommonProductImageEpt(models.Model):
    ...
    #         magento_product_product_obj.browse(magento_variant["id"]).magento_product_image_ids
    ...
    #         for record in self:
    #             magento_product_images +=
    #             magento_product_images.search([("odoo_image_id", "=", record.id)])
