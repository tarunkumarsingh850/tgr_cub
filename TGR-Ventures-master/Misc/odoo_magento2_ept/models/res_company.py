...
class ResCompany(models.Model):
    ...
    magento_onboarding_state = fields.Selection(
        selection=MAGENTO_ONBOARDING_STATES, string="State of the Magento onboarding panel", default="not_done"
    )
    magento_instance_onboarding_state = fields.Selection(
        selection=MAGENTO_ONBOARDING_STATES, string="State of the magneto instance onboarding panel", default="not_done"
    )
    magento_basic_configuration_onboarding_state = fields.Selection(
        MAGENTO_ONBOARDING_STATES, string="State of the magento basic configuration onboarding step", default="not_done"
    )
    magento_financial_status_onboarding_state = fields.Selection(
        MAGENTO_ONBOARDING_STATES, string="State of the onboarding magento financial status step", default="not_done"
    )
    magento_cron_configuration_onboarding_state = fields.Selection(
        MAGENTO_ONBOARDING_STATES, string="State of the onboarding magento cron configurations step", default="not_done"
    )
    is_create_magento_more_instance = fields.Boolean(string="Is create magento more instance?", default=False)
