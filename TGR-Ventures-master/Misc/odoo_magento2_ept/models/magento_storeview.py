...
class MagentoStoreview(models.Model):
    ...
    import_orders_from_date = fields.Datetime(
        ...
        help="Do not consider non-imported sale orders before" " this date. Leave empty to import all sale " "orders",
    )
    ...
    is_use_odoo_order_sequence = fields.Boolean(
        string="Is Use Odoo Order Sequences?", default=False, help="If checked, Odoo Order Sequence is used"
    )
