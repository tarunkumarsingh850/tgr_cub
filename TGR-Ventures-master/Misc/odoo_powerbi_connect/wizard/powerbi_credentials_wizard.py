...
class PowerbiCredentialsWizard(models.TransientModel):
    ...
    update_pwd = fields.Boolean(string="Update Password")
    ...
    def action_update(self):
        ...
        return self.env["powerbi.message.wizard"].genrated_message(
            "Credentials has been updated successfully", name="Credentails updated successfully"
        )
